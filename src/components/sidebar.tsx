...
import { DatabaseIcon, HomeIcon, SettingsIcon, LogOutIcon, CloudIcon } from "lucide-react";
...
>
  ...
  <div className="flex items-center gap-2 overflow-hidden">
    <svg className="h-6 w-6 flex-shrink-0 text-primary" viewBox="0 0 128 112" fill="none" xmlns="http://www.w3.org/2000/svg">
