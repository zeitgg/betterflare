  ...
  async renameObject(bucketName: string, oldKey: string, newKey: string) {
    try {
      ...
      try {
        ...
        console.log("R2Service.renameObject - Object exists, proceeding with rename");
      } catch (error) {
        console.error("R2Service.renameObject - Object does not exist:", error);
        throw new Error(`Object ${oldKey} does not exist in bucket ${bucketName}`);
      }
      ...
      try {
        console.log("R2Service.renameObject - Creating new object with empty content...");
        ...
        console.log("R2Service.renameObject - Empty object created successfully");
        ...
        console.log("R2Service.renameObject - Original object deleted, rename operation complete");
